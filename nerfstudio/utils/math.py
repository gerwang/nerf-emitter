...
# Disable torch.compile when multiple GPUs at it leads to wrong results and when PyCharm as it leads to crash
@torch_compile(dynamic=True, mode="reduce-overhead", backend="eager", disable=True)
def intersect_aabb(
